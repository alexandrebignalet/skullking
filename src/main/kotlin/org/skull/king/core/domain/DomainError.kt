...
data class PlayerAlreadyAnnouncedError(val e: String) : DomainError(e)
class IllegalAnnounceError : DomainError("Announce must be greater than 0 and lower than 10")
