...
class ScoreBonusTest {
    ...
    fun setUp() {
        ...
        await atMost Duration.ofSeconds(5) untilAsserted {
            ...
            Assertions.assertThat(game.scoreBoard[firstPlayer.id]?.find { it.roundNb == firstRoundNb }?.done)
                .isEqualTo(1)
            Assertions.assertThat(game.scoreBoard[firstPlayer.id]?.find { it.roundNb == firstRoundNb }?.potentialBonus)
                .isEqualTo(50)

            Assertions.assertThat(game.scoreBoard[thirdPlayer.id]?.find { it.roundNb == firstRoundNb }?.announced)
                .isEqualTo(firstFoldLoserAnnounce)
            Assertions.assertThat(game.scoreBoard[thirdPlayer.id]?.find { it.roundNb == firstRoundNb }?.done)
                .isEqualTo(0)
            Assertions.assertThat(game.scoreBoard[thirdPlayer.id]?.find { it.roundNb == firstRoundNb }?.potentialBonus)
                .isEqualTo(0)
            ...
            Assertions.assertThat(game.scoreBoard[secondPlayer.id]?.find { it.roundNb == firstRoundNb }?.done)
                .isEqualTo(0)
            Assertions.assertThat(game.scoreBoard[secondPlayer.id]?.find { it.roundNb == firstRoundNb }?.potentialBonus)
                .isEqualTo(0)
        }
    }
    ...
    fun `Should affect a potential bonus to the player playing skullking beating some pirates`() {
        ...
        await atMost Duration.ofSeconds(5) untilAsserted {
            ...
            Assertions.assertThat(game.scoreBoard[newThirdPlayer]?.find { it.roundNb == secondRoundNb }?.done)
                .isEqualTo(1)
            Assertions.assertThat(game.scoreBoard[newThirdPlayer]?.find { it.roundNb == secondRoundNb }?.potentialBonus)
                .isEqualTo(60)
            ...
            Assertions.assertThat(game.scoreBoard[newFirstPlayer]?.find { it.roundNb == secondRoundNb }?.done)
                .isEqualTo(0)
            Assertions.assertThat(game.scoreBoard[newFirstPlayer]?.find { it.roundNb == secondRoundNb }?.potentialBonus)
                .isEqualTo(0)
            ...
            Assertions.assertThat(game.scoreBoard[newSecondPlayer]?.find { it.roundNb == secondRoundNb }?.done)
                .isEqualTo(0)
            Assertions.assertThat(game.scoreBoard[newSecondPlayer]?.find { it.roundNb == secondRoundNb }?.potentialBonus)
                .isEqualTo(0)
        }
